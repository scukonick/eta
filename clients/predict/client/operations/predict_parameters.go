...
import (
	...
	models "github.com/scukonick/eta/clients/predict/models"
)
...
func (o *PredictParams) WithPositionList(positionList *models.PredictParamsBody) *PredictParams {
	o.SetPositionList(positionList)
	return o
}

// SetPositionList adds the positionList to the predict params
func (o *PredictParams) SetPositionList(positionList *models.PredictParamsBody) {
